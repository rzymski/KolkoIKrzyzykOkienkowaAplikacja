...
{
    public partial class Game13x13 : Form
    {
        private int width = 1920;
        private int height = 1080;
        private string symbol = "X";
        private int symbolValue = 1; //0-kolko 1-krzyz 
        private int[,] board2D = new int[13, 13];
        private int chessSize = 13;
        ...
        public Game13x13(int width, int height)
        {
            InitializeComponent();
            this.width = width;
            this.height = height;
        ...
        private void Game13x13_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        public void ButtonArray()
        {
            for(int i=0; i< chessSize*chessSize; i++)
            {
                ...
                btn.Size = new Size((int)(width*6/10/(chessSize+1)), (int)(height*8/10/(chessSize+1)));
                btn.Text = "";
                btn.Click += btn_Click;
        ...
        public void btn_Click(object sender, EventArgs e)
        {
            ...
            int choice = -1;
            int wayToWin = Check.checkIfEndGame(board2D, ++moveCount, chessSize, nr%chessSize, nr/chessSize, 5, ref listWinnerPositions);
            if(wayToWin != 0)
            {
